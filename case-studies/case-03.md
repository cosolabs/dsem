...
| **Evaluator** | Anónimo |
| **Date** | 2026-02-11 |
| **Evidence source(s)** | Sitio web del proveedor (www.dinna.shop) |
...
| **Declared technology** | **App propietaria DINNA.** Compatible con asistentes Amazon Alexa y Google Home. **No declara protocolos** (Zigbee, WiFi, KNX, MQTT, etc.). |
...
|----------|-------------|---------------------|---------------------------|
| **D1 — Infraestructura** | **1/5** | No declara protocolos. Menciona "dispositivos DINNA" pero no especifica si son WiFi, Zigbee u otro. No menciona hub físico ni arquitectura cableada. | *What protocols? What other brands can I connect?* → **No declara. Solo dispositivos de su marca.** |
...
| **D7 — Sustentabilidad del ecosistema** | **1/5** | No informa sobre repuestos a futuro. Ecosistema cerrado de "dispositivos DINNA". Dependencia total de una sola marca. | *Where do I buy a spare part in 5 years?* → **No responde. Sin garantía de repuestos.** |
...
| **Vendor lock-in** | **Crítico.** Ecosistema cerrado de "dispositivos DINNA". No declara protocolos ni admite otras marcas. |
...
1. **Nula operación offline inteligente:** A diferencia de otros casos ultra light que al menos permiten control local vía app, DINNA **reduce el hogar a operación manual convencional** cuando no hay internet. No hay domótica sin conexión.
